...
function noAdjacentMarked(allRows, currentRowNumber) {
    const digits = '0123456789';    //i can ran out, i dont think i can just change them to digits, maybe change each symbol to an object with properties?
    currentRowSet = new RowSet(allRows, currentRowNumber);
